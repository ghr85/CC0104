...
def test_getting_favourite_food
  result = get_fav_food(@person3)
  assert_equal("Scooby snacks", result)
end
...
def test_adding_friend
  ...
  def test_losing_friend
    losing_friend(@person4, "Shaggy")
    result = @person4[:friends].length
...
def test_lend_money
  lend_money(@person4,@person1,20)
  result_1 = @person4[:monies]
  result_2 = @person1[:monies]
  assert_equal(result_1,0)
end
